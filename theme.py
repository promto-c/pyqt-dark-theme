...
def set_theme(app, theme: str = 'dark') -> None:
    ...
    if theme == 'dark':
        ...
        palette.setColor(QtGui.QPalette.ColorRole.Window, QtGui.QColor('#333'))
        palette.setColor(QtGui.QPalette.ColorRole.WindowText, QtGui.QColor('#DDD'))
        palette.setColor(QtGui.QPalette.ColorRole.Base, QtGui.QColor('#222'))
        palette.setColor(QtGui.QPalette.ColorRole.AlternateBase, QtGui.QColor('#333'))
        palette.setColor(QtGui.QPalette.ColorRole.ToolTipBase, QtGui.QColor('#000'))
        palette.setColor(QtGui.QPalette.ColorRole.ToolTipText, QtGui.QColor('#DDD'))
        palette.setColor(QtGui.QPalette.ColorRole.Text, QtGui.QColor('#DDD'))
        palette.setColor(QtGui.QPalette.ColorRole.Button, QtGui.QColor('#444'))
        palette.setColor(QtGui.QPalette.ColorRole.ButtonText, QtGui.QColor('#DDD'))
        palette.setColor(QtGui.QPalette.ColorRole.BrightText, QtGui.QColor('#FFF'))
